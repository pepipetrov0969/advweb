      ...
      <Container className="grid items-center gap-12 py-10 sm:py-14 lg:grid-cols-2 lg:py-16">
        <div className="animate-fade-up">
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-clay">
            Предоставям професионална правна помощ и ефективни решения с
            внимание към всеки детайл, индивидуален подход и ангажираност
            към защитата на вашите права и законни интереси.
          </p>
